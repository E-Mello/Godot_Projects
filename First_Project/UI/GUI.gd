...
func set_new_health_value(new_health: int):
	...
	var highligth_color = Color("#ff7e7e")
	...
	health_tween.interpolate_property(bar_style, "bg_color", original_color, highligth_color, 0.2, Tween.TRANS_LINEAR, Tween.EASE_IN)
	health_tween.interpolate_property(bar_style, "bg_color", highligth_color, original_color, 0.2, Tween.TRANS_LINEAR, Tween.EASE_OUT, 0.2)
	health_tween.start()
